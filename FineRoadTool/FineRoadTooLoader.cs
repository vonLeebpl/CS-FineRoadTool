    ...
    public class FineRoadToolLoader : LoadingExtensionBase
    {
        public override void OnLevelLoaded(LoadMode mode)
        {
            if (FineRoadTooLoader.instance == null)
            {
                ...
                FineRoadTooLoader.instance = new GameObject("FineRoadTool").AddComponent<FineRoadTooLoader>();

                // Don't destroy it
                GameObject.DontDestroyOnLoad(FineRoadTooLoader.instance);
            }
            else
            {
                FineRoadTooLoader.instance.Start();
                FineRoadTooLoader.instance.enabled = true;
            }
        }
        ...
        public override void OnLevelUnloading()
        {
            if (FineRoadTooLoader.instance != null)
            {
                FineRoadTooLoader.instance.enabled = false;
            }
        }
    }

    public class FineRoadTooLoader : MonoBehaviour
    {
        ...
        public static FineRoadTooLoader instance;
        ...
        public class AfterSimulationTick : ThreadingExtensionBase
        {
            ...
            {
                if (FineRoadTooLoader.instance == null || !FineRoadTooLoader.instance.enabled) return;

                try
                {
                    FineRoadTooLoader.instance.OnAfterSimulationTick();
                }
                catch (Exception e)
                {
